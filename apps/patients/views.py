        ...
        if form.is_valid():
            ...
            try:
                patient = register_patient(
                    ...
                    nok_county=cd.get('nok_county', 'Nairobi'),
                    nok_sub_county=cd.get('nok_sub_county', ''),
                    nok_ward=cd.get('nok_ward', ''),
                    nok_nearest_stage=cd.get('nok_nearest_stage', ''),
                    ...
                    caregiver_county=cd.get('caregiver_county', 'Nairobi'),
                    caregiver_sub_county=cd.get('caregiver_sub_county', ''),
                    caregiver_ward=cd.get('caregiver_ward', ''),
                    caregiver_nearest_stage=cd.get('caregiver_nearest_stage', ''),
