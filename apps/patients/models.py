...
class NextOfKin(models.Model):
    ...
    alternative_phone = models.CharField(max_length=30, blank=True)
    email = models.EmailField(blank=True)
    county = models.CharField(max_length=100, blank=True, default='Nairobi', verbose_name=_('County'))
    sub_county = models.CharField(max_length=100, blank=True, verbose_name=_('Sub-County'))
    ward = models.CharField(max_length=100, blank=True, verbose_name=_('Ward'))
    nearest_stage = models.CharField(max_length=255, blank=True, verbose_name=_('Nearest Bus Stop / Stage'))
    address = models.CharField(max_length=255, blank=True, verbose_name=_('Estate / Residence'))
